    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        ...
        http.authorizeHttpRequests(request -> {
            request.requestMatchers("/api/auth/login").permitAll()
                    ...
                    .requestMatchers(HttpMethod.POST, "/api/auth/logout").hasAnyRole("REGISTERED_USER", "DRIVER", "ADMIN")
                    .requestMatchers(HttpMethod.PUT, "/api/auth/driver/status").hasRole("DRIVER")
